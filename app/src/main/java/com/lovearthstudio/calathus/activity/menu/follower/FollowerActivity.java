package com.lovearthstudio.calathus.activity.menu.follower;
...
public class FollowerActivity extends BaseActivity {
    ...
    public FollowerListRequsetParams params;
    public Gson gson=new Gson();
    public FollowerCallBack fansCallBack=new FollowerCallBack();
            ...
            switch (msg.what) {
                ...
                case NO_MORE_DATA:
                    if(isPulling){
                        listView.refreshComplete();
                        isPulling=false;
                        Toast.makeText(getApplication(), "已经最新", Toast.LENGTH_SHORT).show();
                    }
                    if(isPushing){
                        listView.loadMoreComplete();
                        isPushing=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FollowerAdapter(this, ja);
        listView.setAdapter(adapter);

        params = new FollowerListRequsetParams();
        params.dua_id=6;
    ...
    public void getFansList(){
        ...
        try{
            ...
            OkHttpUtil.asyncPost(Constant.userUrl,gson.toJson(params),fansCallBack);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public class FollowerCallBack implements Callback{
        @Override
    ...
    public class FollowerListRequsetParams{
        public long dua_id;
